...
#        print("Representation of the best schedule:")
        ...
        supply, = plt.plot(timeRange,renewablePowerSchedule,':k',label="Renewable Supply Schedule",color="blue",marker='*',hold="True")  
        demand, = plt.plot(timeRange,bestEnergyConsumptionSchedule.sum(axis=0),label="Energy Consumption Schedule",color="red",marker="o",hold="True")
...
#        print("Representation of the best schedule:")
        plt.figure()
        plt.suptitle("Representation of the best schedule",verticalalignment = "top")
#        plt.title("Representation of the best schedule",verticalalignment="top")        
        plt.imshow(bestEnergyConsumptionSchedule,cmap="PuRd",interpolation="nearest")
        plt.axis("off")
        plt.colorbar(orientation="horizontal")
#        plt.tight_layout()
